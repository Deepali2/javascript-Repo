...
const person = new Person("Elie", "Schooppik", "purple", 34)
...
// 4 - Create a class for a Car. Each object created from the Car function should also have a make, model, and year and a 
//property called numWheels which should be 4. The Car prototype should inherit all of the methods from the Vehicle prototype
...
const vehicle = new Vehicle("Tractor", "John Deere", 1999);
